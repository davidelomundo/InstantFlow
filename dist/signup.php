                    ...
                    <div class="page-header-content">
                        <div class="container">
                            <div class="row align-items-center">
                                <div class="col-lg-6">
                                    <h1 class="page-header-title">Esegui l'iscrizione per accedere al catalogo</h1>
                                </div>
                                <div class="col-lg-6">
                                    <div class="card rounded-lg text-dark" data-aos="fade-up">
                                        <div class="card-header py-4">Iscrizione</div>
                                        <div class="card-body">
                                            <form method="POST">
                                                <div class="form-row">
                                                    <div class="form-group col-md-6"><label class="small text-gray-600" for="leadCapFirstName">Nome</label><input class="form-control rounded-pill" id="leadCapFirstName" name="firstName" type="text"/></div>
                                                    <div class="form-group col-md-6"><label class="small text-gray-600" for="leadCapLastName">Cognome</label><input class="form-control rounded-pill" id="leadCapLastName" name="lastName" type="text" /></div>
                                                </div>
                                                ...
                                                <div class="form-group"><label class="small text-gray-600" for="leadCapCompany">Conferma Password</label><input class="form-control rounded-pill" id="leadCapCompany" name="confermaPassword" type="password" /></div>
                                                <button class="btn btn-primary btn-marketing btn-block rounded-pill mt-4" type="submit">Iscriviti</button>
                                            </form>
                                        </div>
                                    </div>
                                </div>
