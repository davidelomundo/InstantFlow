                    ...
                    <div class="page-header-content pt-10">
                        <div class="container text-center">
                            <div class="row justify-content-center">
                                <div class="col-lg-8">
                                    <h1 class="page-header-title mb-3">Generi</h1>
                                    <p class="page-header-text">La tua raccolta filtrata per genere.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <section class="bg-light py-10">
                    <div class="container">
                        <?php foreach($stmtGenere as $rowGenere) { 
                            ...
                            ?>
                        <h2 class="mb-4"><?php echo $rowGenere["nome"]; ?></h2>
                        <div class="row">
            ...
            <footer class="footer pt-10 pb-5 mt-auto bg-dark footer-dark">
                <div class="container">
                    ...
                    <div class="row align-items-center">
                        <div class="col-md-6 small">Copyright &copy; InstantFlow 2020</div>
