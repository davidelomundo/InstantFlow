                        ...
                        <div class="collapse navbar-collapse" id="navbarSupportedContent">
                            <ul class="navbar-nav ml-auto mr-lg-5">
                                <li class="nav-item dropdown no-caret">
                                    <a class="nav-link dropdown-toggle" id="navbarDropdownDocs" href="#" role="button" data-toggle="dropdown">Profile<i class="fas fa-chevron-right dropdown-arrow"></i></a>
                    ...
                    <div class="container">
                        <div class="row text-center">
                            <div class="col align-self-center">
                                ...
                                <h3>Expiration</h3>
                                <p class="mb-0">Your subscription expires on <?php echo date("d/m/Y", strtotime($rowSubscription["scadenza"])); ?>.</p>
                            </div>
                        </div>
                    </div>
                </section>
