                    ...
                    <table class="table table-borderless mb-0">
                        ...
                        <tbody>
                            ...
                            <tr class="border-bottom">
                                <td>
                                    <div class="font-weight-bold">Subscription <?php echo $rowCategory["name"]; ?></div>
                                    <div class="small text-muted d-none d-md-block">The <?php echo $rowCategory["name"]; ?> subscription will give you access to the entire movie catalog until <?php echo date('d/m/Y', strtotime(date('Y-m-d') . ' + 30 days')); ?></div>
                                </td>
                                <td class="text-right font-weight-bold">1</td>
                                <td class="text-right font-weight-bold">€<?php echo $rowCategory["price"]; ?></td>
                            </tr>
                            <!-- Invoice total-->
                            <tr>
                                ...
                                <td class="text-right pb-0">
                                    <div class="h5 mb-0 font-weight-700 text-green">€<?php echo $rowCategory["price"]; ?></div>
                                </td>
                            </tr>
                        </tbody>
                    </table>
                        ...
                        paypal.Buttons({
                            ...
                            createOrder: function(data, actions) {
                                return actions.order.create({
                                    purchase_units: [{
                                        amount: {
                                            value: <?php echo $rowCategory["price"]; ?>
                                        }
                                    }]
                                })
                            },
